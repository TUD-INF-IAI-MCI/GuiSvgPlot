...
public class CsvEditorController implements Initializable {
	...
	public void init(HashMap<DiagramType, File> fileMap, String csvPath, GuiSvgOptions guiSvgOptions,
			SVGWizardController svgWizardController) throws IOException {
	...
	private void initFunctions() {
		...
		tableColumn_FunctionDelete.setCellValueFactory(btn -> {
			...
			b.setOnAction(event -> functions.remove(btn.getValue()));
