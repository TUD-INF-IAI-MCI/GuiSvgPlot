...
public class RootFrameController implements Initializable {
    ...
    private PresetsController presetsController = PresetsController.getInstance();
    ...
    public void init() {
        ...
        this.button_StartFunction.setOnAction(event -> startFunction());
        ...
        this.menuItem_Save_Preset.setOnAction(event -> saveAsPreset());
    ...
    private void showCsvHelper() {
        ...
        try {
            ...
            ((Button) stage.getScene().lookup("#button_close")).setOnAction(event -> stage.close());
    ...
    private void startFunction() {
        ...
        startWizard(GuiSvgPlott.FunctionWizardFrame, true);
    }
    ...
    private void startWizard(URL fxmlPath, boolean isExtended) {
        ...
        try {
            center = borderPane_Content.getCenter();
            borderPane_Content.setCenter(loader.load());
            svgWizardController = loader.getController();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//        this.scrollPane_message.getStyleClass().clear();
        ...
        if (this.svgWizardController != null) {
    ...
    private void setSceneTitle(final String messageCode) {
